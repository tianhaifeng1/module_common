package com.example.qualityshield.dialog;
...
import com.example.module_common.tdialog.BaseDialog;
...
public class RemindDialog extends BaseDialog implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(!param.affirmText.equals("")){
            viewHolder.mDialogRemindAffirm.setVisibility(View.VISIBLE);
        }
