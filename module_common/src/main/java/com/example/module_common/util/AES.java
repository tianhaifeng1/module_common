...
public class AES {
    ...
    private static String iv = "2018011618270000";//偏移量字符串必须是16位 当模式是CBC的时候必须设置偏移量
    ...
    public static String getPwd(String pwd) {
        try {
            ...
            // 密钥必须是16的倍数
            byte key[] = "20180116182700002018011618270000".getBytes("utf-8");//hexStringToBytes("0123456789ABCDEF");

            String enc = byteToHexString(encrypt(pwd, key));
            return enc;
